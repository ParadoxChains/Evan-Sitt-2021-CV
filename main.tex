...
\personalinfo{%
  ...
  \mailaddress{3511 Christoval RD, TRLR 521, San Angelo, TX 76903 United States}
...
\cvevent{Junior Developer}{Farm Fare}{April 2020 -- April 201}{Cleveland, Ohio}
\small{
\begin{itemize}
...
\cvevent{Freelance Music Composer and Producer}{Freelance Sole Proprietorship}{August 2008 -- Ongoing}{USA}
\small{
\begin{itemize}
    \item Created original soundtracks for five Steam releases and three mobile games.
    \item Compose and produce music tracks for client projects and commissions.
    \item Manage client communications and business arrangements.
    \item Develop streaming channel and coordinate work with other freelancers.
    \item Handle marketing strategy and social media presences.
\end{itemize}
}
