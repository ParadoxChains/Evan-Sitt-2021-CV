...
\name{Evan Sitt}
\tagline{Backend Developer | Support Engineer}
...
\cvevent{Support Engineer}{Microsoft}{June 2021 -- Current}{San Angelo, Texas}
\small{
\begin{itemize}
\item Assist customers with setup and management of Microsoft's Azure cloud infrastructure to best fit the customer's business needs.
